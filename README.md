...
master: [![Build Status](https://travis-ci.org/Link-/uber_data.svg?branch=master)](https://travis-ci.org/Link-/uber_data)
...
alpha-0.0.2: [![Build Status](https://travis-ci.org/Link-/uber_data.svg?branch=alpha-0.2.2)](https://travis-ci.org/Link-/uber_data)
